...
function SocialMedia() {
    ...
    const tags1 = [
        ...
        { label: "Sony Liv",icon: "./assets/images/sm/sony.jpeg" },
        { label: "Zee 5",icon: "./assets/images/sm/zee5.png"},
    ];
  ...
  return (
    <div className="container ">
      <div className="SMapp ">
        ...
        <div className="SMHeader col-md-5">
          <h1>Stream your favorites on demand!</h1>
          <p className="mt-3">With eligible plans, access FREE OTT videos on any device using your Zeta Set-top Box login.</p>
        </div>

        <div className="SMtag-list mb-4 col-md-6 ">
