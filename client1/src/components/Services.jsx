        ...
        <div className="container text-light mt-4 ">
          ...
          <div className="row gy-4 py-2" data-aos="zoom-in">
            ...
            <div className="col-lg-4">
              <div className="card bg-transparent">
              <div className="ripplebutton">
                <i className="fa-solid fa-phone text-white "></i></div>
                <h4 className="py-2">HOME BROADBAND</h4>
                <p className="para-light">
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                  Magnam odit consequatur doloribus natus in suscipit!
            ...
            <div className="col-lg-4">
              ...
              <i className="fa-solid fa-mobile-screen-button text-white"></i>    
               ...
               <h4 className="py-2">MOBILE CONNECTION</h4>
                <p className="para-light">
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                  Magnam odit consequatur doloribus natus in suscipit!
                </p>
            ...
            <div className="col-lg-4">
              <div className="card bg-transparent">
              <div className="ripplebutton">
              <i className="fa-solid fa-shield-halved text-white"></i>                </div>
                <h4 className="py-2">SECURITY</h4>
                <p className="para-light">
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                  Magnam odit consequatur doloribus natus in suscipit!
                </p>
            ...
            <div className="col-lg-4">
              <div className="card bg-transparent">
              <div className="ripplebutton">
              <i className="fa-solid fa-tv text-white"></i>                </div>
